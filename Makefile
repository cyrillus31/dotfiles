...
STOW_DIRS := aerospace alacritty iterm2 kitty shell shell_bash_fedora shell_yandex shell_cloud_ru starship tmux vim shell_zsh private_files rustyvibes qtile herdr

# Define groups of configurations
COMMON_TARGETS := shell starship tmux vim kitty rustyvibes private_files herdr
